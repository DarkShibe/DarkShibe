...
!define URL http://www.darkshibe.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/darkshibe.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\darkshibe-qt.exe
...
OutFile darkshibe-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/darkshibe-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/darkshibed.exe
    ...
    #Delete /REBOOTOK $INSTDIR\darkshibe.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\darkshibe-qt.exe
